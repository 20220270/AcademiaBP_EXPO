...
$pdf->startReport('Proyección de alumnos con mejor desempeño');
// Se instancia el módelo Categoría para obtener los datos.
$alumno = new AlumnosData;
// Se verifica si existen registros para mostrar, de lo contrario se imprime un mensaje.
if ($dataAlumnos = $alumno->pruebaReporte()) {
    ...
    $pdf->cell(185, 8, $pdf->encodeString('Los 7 alumnos con mejor desempeño durante el año'), 1, 1, 'C', 1);
    // Se imprimen las celdas con los encabezados.
    $pdf->cell(40, 10, 'Imagen', 1, 0, 'C', 1);
    $pdf->cell(65, 10, 'Nombre del alumno', 1, 0, 'C', 1);
    $pdf->cell(80, 10, $pdf->encodeString('Proyección de desempeño durante los entrenos'), 1, 1, 'C', 1);
    ...
    foreach ($dataAlumnos as $rowAlumnos) {
        ...
        $imgPath = "../../images/productos/" . $rowAlumnos['imagen_producto'];
        ...
        $pdf->cell(65, $cellHeight, $rowAlumnos['nombre_producto'], 1, 0, 'C');
        $pdf->cell(80, $cellHeight, $pdf->encodeString( $rowAlumnos['promedio_final']), 1, 1, 'C');
    }
} else {
