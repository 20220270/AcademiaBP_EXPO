...
const ESTADO_SELECT = document.getElementById('nivelSelect');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //Combobox para la búsqueda de administradores
    fillSelect2(NIVELESUSUARIO_API, 'readAll', 'nivelSelect');

    document.getElementById('toggleViewBtn').addEventListener('click', () => {
        if (currentMethod === 'readAll') {
            currentMethod = 'readAllActivos';
            document.getElementById('toggleViewBtn').textContent = 'Administradores inactivos';
        }
        else if (currentMethod === 'readAllActivos') {
            currentMethod = 'readAllInactivos';
            document.getElementById('toggleViewBtn').textContent = 'Administradores recientes';
        }
        else if (currentMethod === 'readAllInactivos') {
            currentMethod = 'readAllAdminsRecientes';
            document.getElementById('toggleViewBtn').textContent = 'Administradores antiguos';
        }
        else {
            currentMethod = 'readAll';
            document.getElementById('toggleViewBtn').textContent = 'Administradores activos';
        }
        fillTable();
    })
});
...
function realizarBusqueda() {
    ...
    FORM.append('nivelSelect', estadoSeleccionado);  // Agrega el estado al FormData
