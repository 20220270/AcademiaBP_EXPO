...
if ('webkitSpeechRecognition' in window) {
    ...
    const micButton = document.getElementById('microphone-button2'); //llamamos al ícono del micrófono
    const searchInput = document.getElementById('Buscador2'); //Llamamos a la barra de búsuqeda
