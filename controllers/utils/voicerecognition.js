...
if ('webkitSpeechRecognition' in window) {
    ...
    const micButton = document.getElementById('microphone-button'); //llamamos al ícono del micrófono
    const searchInput = document.getElementById('Buscador'); //Llamamos a la barra de búsuqeda
